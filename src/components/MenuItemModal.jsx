            ...
            <div className="cart-count-btn">
              <button className="count-btn" onClick={onRemove}>
                <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="21" height="20" rx="5" fill="#410C00"/>
                  <path d="M14.5328 9.16655V11.4659H6.47168V9.16655H14.5328Z" fill="white"/>
                </svg>
              </button>
              ...
              <button className="count-btn" onClick={onAdd}>
                <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="21" height="20" rx="5" fill="#410C00"/>
                  <path d="M9.30371 15.8459V3.84304H11.6919V15.8459H9.30371ZM4.5008 11.0341V8.64595H16.5036V11.0341H4.5008Z" fill="white"/>
                </svg>
              </button>
            </div>
          </div>
